    ...
    <div class="offcanvas-body p-0">
      <nav class="navbar-light">
        <ul class="navbar-nav">
          ...
          <li>
            ...
            <div class="side collapse" id="llayouts">
              <ul class="side navbar-nav ps-3">
                <li>
                  <a href="login/kantor/kantor.php" class="side nav-link px-3">
                    <span class="fa fa-home mdi-light"></span>
                    <span class="side">Kantor</span>
                  </a>
                </li>
                <li>
                  <a href="login/ruang_tamu/ruang_tamu.php" class="side nav-link px-3">
                    <span class="fa fa-home mdi-light"></span>
          ...
          <li>
            <a href="login/ruangan/indexruangan.php" class="side nav-link px-3">
  ...
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <br>
          <h4>Selamat Datang di Website Kelambaban & Suhu Gedung A</h4>
