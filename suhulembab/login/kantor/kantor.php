    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <br>
          <!-- Alert Kelembaban -->
          <?php $querykelembaban = mysqli_query($conn, "SELECT * FROM tb_kelembaban WHERE id_ruangan = 1 ORDER BY id DESC LIMIT 1");
          ...
          <!-- Alert Suhu -->
          <?php $querysuhu = mysqli_query($conn, "SELECT * FROM tb_suhu WHERE id_ruangan = 1 ORDER BY id_suhu DESC LIMIT 1");
              ...
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  ...
                  <div class="text">
                    ...
                    <h2>
                      <?php $result1 = mysqli_query($conn, "SELECT * FROM tb_kelembaban WHERE id_ruangan = 1 ORDER BY id DESC LIMIT 1"); ?>
              ...
              <div class="overview__inner">
                <div class="overview-box clearfix">
                  ...
                  <div class="text">
                    <span>Suhu</span>
                    <h2>
                      <?php $result = mysqli_query($conn, "SELECT * FROM tb_suhu WHERE id_ruangan = 1 ORDER BY id_suhu DESC LIMIT 1"); ?>
            ...
            <div class="modal-dialog modal-sm" role="document">
              <div class="modal-content">
                ...
                <form action="prosesinputkelembaban.php" method="post" style="margin-left: 10px; margin-right: 10px">
                  <div class="mt-2">
                    <?php $result = mysqli_query($conn, "SELECT * FROM tb_kelembaban WHERE id_ruangan = 1 ORDER BY id DESC LIMIT 1"); ?>
                    <?php foreach ($result as $row) : ?>
        ...
        <div class="modal-content">
          ...
          <form action="" method="post" style="margin-left: 10px; margin-right: 10px">
            ...
            <p>Kelembaban Ruangan Ideal
              <b>
                <?php $result = mysqli_query($conn, "SELECT * FROM tb_set_poin WHERE id_ruangan = 1"); ?>
                <?php foreach ($result as $row) : ?>
                  <?= $row['kelembaban']; ?>
                <?php endforeach;
                ?>
